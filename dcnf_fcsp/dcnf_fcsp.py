...
config_write = {'program':__file__, 'commitID':commit_id, 'N_EPOCH':N_EPOCH, 'BATCHSIZE':BATCHSIZE, 'WIDTH_IMG':WIDTH_IMG, 'HEIGHT_IMG':HEIGHT_IMG, 'GPU':args.gpu, 'ARCH':args.arch, 'OPTIMIZER':args.optimizer, 'RUN_at':run_at, 'learningrate':args.learningrate, 'momentum':args.momentum}
...
STRIDE = model.p_w * model.p_l
WIDTH_Y1 = WIDTH_IMG
HEIGHT_Y1 = HEIGHT_IMG
for i_w in range(model.p_l):
    WIDTH_Y1 /= model.p_w
    HEIGHT_Y1 /= model.p_w
